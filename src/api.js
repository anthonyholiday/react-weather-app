...
export function getEpochDate(timestamp)  {
...
export const fetchWeatherData = async () => {
    try {
        ...
        const [weatherResponse, cityResponse] = await Promise.all([
            ...
            fetch(`https://api.openweathermap.org/geo/1.0/reverse?lat=${coords.lat}&lon=${coords.lon}&limit=1&appid=3bef3c5e53663333556ee7731fc82d1c`)
        ]);
